...
void GB1ExpGridOrbGradientFn::add(double coeff, double alpha0, const double *scales0) {
  ...
  do {
    ...
    if (i1p.n0[1] > 0)
      work_cart[3 * i1p.ibasis0 + 1] +=
          i1p.n0[1] * pre0 * poly_work[i1p.ibasis0 - nnotx + offset_l1];

    // Basis function derived toward z
    work_cart[3 * i1p.ibasis0 + 2] += pre0_h * poly_work[i1p.ibasis0 + 2 + nnotx + offset_h1];
    if (i1p.n0[2] > 0)
      work_cart[3 * i1p.ibasis0 + 2] +=
          i1p.n0[2] * pre0 * poly_work[i1p.ibasis0 - nnotx - 1 + offset_l1];
  } while (i1p.inc());
}
...
void GB1DMGridHessianFn::add(double coeff, double alpha0, const double *scales0) {
  ...
  do {
    ...
    work_cart[10 * i1p.ibasis0 + 4] +=
        (2 * i1p.n0[0] + 1) * pre0_h * poly_work[i1p.ibasis0 + offset];
    if (i1p.n0[0] > 1)
    ...
    if (i1p.n0[0] > 0)
      work_cart[10 * i1p.ibasis0 + 5] +=
          i1p.n0[0] * pre0_h * poly_work[i1p.ibasis0 + 1 + nnotx + offset];
    if (i1p.n0[1] > 0)
      work_cart[10 * i1p.ibasis0 + 5] +=
          i1p.n0[1] * pre0_h * poly_work[i1p.ibasis0 - nnotx + offset];
    ...
    if (i1p.n0[0] > 0)
      work_cart[10 * i1p.ibasis0 + 6] +=
          i1p.n0[0] * pre0_h * poly_work[i1p.ibasis0 + 2 + nnotx + offset];
    if (i1p.n0[2] > 0)
      work_cart[10 * i1p.ibasis0 + 6] +=
          i1p.n0[2] * pre0_h * poly_work[i1p.ibasis0 - 1 - nnotx + offset];
    ...
    work_cart[10 * i1p.ibasis0 + 7] +=
        pre0_hh * poly_work[i1p.ibasis0 + 3 + 2 * nnotx + offset_h2];
    work_cart[10 * i1p.ibasis0 + 7] +=
        (2 * i1p.n0[1] + 1) * pre0_h * poly_work[i1p.ibasis0 + offset];
    if (i1p.n0[1] > 1)
    ...
    work_cart[10 * i1p.ibasis0 + 8] +=
        pre0_hh * poly_work[i1p.ibasis0 + 4 + 2 * nnotx + offset_h2];
    if (i1p.n0[1] > 0)
      work_cart[10 * i1p.ibasis0 + 8] +=
          i1p.n0[1] * pre0_h * poly_work[i1p.ibasis0 + 1 + offset];
    if (i1p.n0[2] > 0)
      work_cart[10 * i1p.ibasis0 + 8] +=
          i1p.n0[2] * pre0_h * poly_work[i1p.ibasis0 - 1 + offset];
    ...
    work_cart[10 * i1p.ibasis0 + 9] +=
        pre0_hh * poly_work[i1p.ibasis0 + 5 + 2 * nnotx + offset_h2];
    work_cart[10 * i1p.ibasis0 + 9] +=
        (2 * i1p.n0[2] + 1) * pre0_h * poly_work[i1p.ibasis0 + offset];
    if (i1p.n0[2] > 1)
