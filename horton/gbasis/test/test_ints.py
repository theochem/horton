...
def test_erf_repulsion_0_0_1_1():
    check_erf_repulsion(
        ...
        np.array([ 1.38523,  1.77715,  0.8249 ]),
        0, 0, 1, 1,
        np.array([[[[0.57999607, 0.04732015, 0.00079488], [0.09549513, 0.42707461, 0.03630467], [-0.15902635, -0.25704193, 0.12295133]]]]), 10000)
...
def test_erf_repulsion_0_1_0_1():
    check_erf_repulsion(
        ...
        np.array([ 1.21516,  1.84023,  1.59345]),
        0, 1, 0, 1,
        np.array([[[[1.11620596, 0.60061237, 0.36843148]], [[-0.05340867, 0.33119515, -0.70418275]], [[-0.04504112, -1.01394262, 1.17313632]]]]), 10000)
...
def test_erf_repulsion_0_1_1_1():
    check_erf_repulsion(
        ...
        np.array([ 0.67873,  0.76053,  0.57816]),
        0, 1, 1, 1,
        np.array([[[[-0.06633908, -0.13761956, -0.03005655], [-0.023407, -0.07813472, -0.03489736], [-0.02263273, -0.20143856, -0.03550443]], [[-0.40044718, -0.35436776, 0.07827812], [-0.39382673, -0.18295174, 0.10845718], [-0.37310311, -0.34400264, 0.05152883]], [[0.07743294, -0.04648822, -0.2043075], [0.03540926, -0.00400861, -0.13446393], [0.02364929, -0.01807209, -0.18079094]]]]), 10000)
...
def test_erf_repulsion_1_0_0_1():
    check_erf_repulsion(
        ...
        np.array([ 0.79184,  1.41932,  1.32812]),
        1, 0, 0, 1,
        np.array([[[[0.16173756, 0.14265052, 0.05405344]]], [[[-0.431925, -0.37295006, -0.1782411]]], [[[-0.17915755, -0.20235955, 0.03526912]]]]), 10000)
...
def test_erf_repulsion_1_1_1_1():
    check_erf_repulsion(
        ...
        np.array([ 1.57111,  0.74218,  0.68171]),
        1, 1, 1, 1,
        np.array([[[[5.38092832, 0.67101024, 0.50643354], [-0.36637823, -0.17128347, 0.00749151], [-0.47015285, -0.00846274, -0.23514519]], [[0.31412053, 1.85552661, -0.05096966], [0.5668773, 0.04019152, -0.05803149], [-0.02195855, 0.00256108, 0.03373068]], [[0.26139911, -0.05908764, 1.34729127], [0.03563575, 0.02599451, 0.0669569], [0.6249628, -0.09012696, -0.02559206]]], [[[-1.30079959, 0.06525516, -0.24130176], [7.90805546, 0.5029288, 1.03164863], [0.22531828, -0.01518479, -0.63472654]], [[0.07758755, -0.30344079, 0.03679751], [0.88274549, 3.43263474, -0.20761467], [0.09249023, 0.10854722, 0.15741632]], [[0.0082139, -0.00382022, -0.24202072], [0.44155444, -0.06437548, 2.40552259], [0.29276089, 0.01725224, 0.05956368]]], [[[-1.45339037, -0.37266055, 0.25844897], [0.41152374, -0.40525461, -0.16607501], [14.23224926, 2.34068558, 0.65653732]], [[-0.00776144, -0.38261119, -0.0073076], [0.28311943, 0.14089539, 0.08426703], [0.91304633, 5.92042353, -0.12886949]], [[0.09807363, 0.06281554, -0.25920407], [0.15636252, 0.10752926, 0.14182457], [1.2142302, -0.38098265, 4.57694241]]]]), 10000)
...
def test_erf_repulsion_4_3_2_1():
    check_erf_repulsion(
        ...
        [0.0389816, -0.01461239, 0.32867428], [0.0156239, -0.02040629,
        -0.07047258], [-0.01363156, -0.1012887, 1.73232784], [-0.00589741,
        -0.00412306, -0.41232763], [0.06147983, -0.06748816, 2.6480163]]]]), 10000)
...
def check_gauss_repulsion(alphas0, alphas1, alphas2, alphas3, r0, r1, r2, r3, scales0, scales1, scales2, scales3, shell_type0, shell_type1, shell_type2, shell_type3, result0, c, alpha):
    # This test compares output from HORTON with reference data computed with
    # J. Toulousse and A. Savin's code.
    max_shell_type = 4
    max_nbasis = get_shell_nbasis(max_shell_type)
...
def get_erf(alphas0, alphas1, alphas2, alphas3, r0, r1, r2, r3, scales0, scales1, scales2, scales3, shell_type0, shell_type1, shell_type2, shell_type3, mu):
    max_shell_type = 4
    max_nbasis = get_shell_nbasis(max_shell_type)
    gb4i = GB4ErfIntegralLibInt(max_shell_type, mu)
...
def check_ralpha_repulsion(alphas0, alphas1, alphas2, alphas3, r0, r1, r2, r3, scales0, scales1, scales2, scales3, shell_type0, shell_type1, shell_type2, shell_type3, result0, ralpha):
    # This test compares output from HORTON with reference data computed with
    # PyQuante.
    max_shell_type = 4
    max_nbasis = get_shell_nbasis(max_shell_type)
...
def test_ralpha_repulsion_0_0_1_1():
    check_ralpha_repulsion(
        ...
        np.array([ 1.38523,  1.77715,  0.8249 ]),
        0, 0, 1, 1,
        np.array([[[[0.57999607, 0.04732015, 0.00079488], [0.09549513, 0.42707461, 0.03630467], [-0.15902635, -0.25704193, 0.12295133]]]]), -1.0)
...
def test_ralpha_repulsion_0_1_0_1():
    check_ralpha_repulsion(
        ...
        np.array([ 1.21516,  1.84023,  1.59345]),
        0, 1, 0, 1,
        np.array([[[[1.11620596, 0.60061237, 0.36843148]], [[-0.05340867, 0.33119515, -0.70418275]], [[-0.04504112, -1.01394262, 1.17313632]]]]), -1.0)
...
def test_ralpha_repulsion_0_1_1_1():
    check_ralpha_repulsion(
        ...
        np.array([ 0.67873,  0.76053,  0.57816]),
        0, 1, 1, 1,
        np.array([[[[-0.06633908, -0.13761956, -0.03005655], [-0.023407, -0.07813472, -0.03489736], [-0.02263273, -0.20143856, -0.03550443]], [[-0.40044718, -0.35436776, 0.07827812], [-0.39382673, -0.18295174, 0.10845718], [-0.37310311, -0.34400264, 0.05152883]], [[0.07743294, -0.04648822, -0.2043075], [0.03540926, -0.00400861, -0.13446393], [0.02364929, -0.01807209, -0.18079094]]]]), -1.0)
...
def test_ralpha_repulsion_1_0_0_1():
    check_ralpha_repulsion(
        ...
        np.array([ 0.79184,  1.41932,  1.32812]),
        1, 0, 0, 1,
        np.array([[[[0.16173756, 0.14265052, 0.05405344]]], [[[-0.431925, -0.37295006, -0.1782411]]], [[[-0.17915755, -0.20235955, 0.03526912]]]]), -1.0)
...
def test_ralpha_repulsion_1_1_1_1():
    check_ralpha_repulsion(
        ...
        np.array([ 1.57111,  0.74218,  0.68171]),
        1, 1, 1, 1,
        np.array([[[[5.38092832, 0.67101024, 0.50643354], [-0.36637823, -0.17128347, 0.00749151], [-0.47015285, -0.00846274, -0.23514519]], [[0.31412053, 1.85552661, -0.05096966], [0.5668773, 0.04019152, -0.05803149], [-0.02195855, 0.00256108, 0.03373068]], [[0.26139911, -0.05908764, 1.34729127], [0.03563575, 0.02599451, 0.0669569], [0.6249628, -0.09012696, -0.02559206]]], [[[-1.30079959, 0.06525516, -0.24130176], [7.90805546, 0.5029288, 1.03164863], [0.22531828, -0.01518479, -0.63472654]], [[0.07758755, -0.30344079, 0.03679751], [0.88274549, 3.43263474, -0.20761467], [0.09249023, 0.10854722, 0.15741632]], [[0.0082139, -0.00382022, -0.24202072], [0.44155444, -0.06437548, 2.40552259], [0.29276089, 0.01725224, 0.05956368]]], [[[-1.45339037, -0.37266055, 0.25844897], [0.41152374, -0.40525461, -0.16607501], [14.23224926, 2.34068558, 0.65653732]], [[-0.00776144, -0.38261119, -0.0073076], [0.28311943, 0.14089539, 0.08426703], [0.91304633, 5.92042353, -0.12886949]], [[0.09807363, 0.06281554, -0.25920407], [0.15636252, 0.10752926, 0.14182457], [1.2142302, -0.38098265, 4.57694241]]]]), -1.0)
...
def test_ralpha_repulsion_4_3_2_1():
    check_ralpha_repulsion(
        ...
        [0.0389816, -0.01461239, 0.32867428], [0.0156239, -0.02040629,
        -0.07047258], [-0.01363156, -0.1012887, 1.73232784], [-0.00589741,
        -0.00412306, -0.41232763], [0.06147983, -0.06748816, 2.6480163]]]]), -1.0)
