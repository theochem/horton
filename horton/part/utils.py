...
radius_becke = dict([(k, v if v is None else v * angstrom) for k, v in radius_becke.iteritems()])
...
radius_covalent = dict([(k, v if v is None else v * angstrom) for k, v in radius_covalent.iteritems()])
