...
with HORTON. Moreovere, both all-electron and pseudo-potential
...
supported by most spreadsheet softwares.
...
mainly because, in this case, ``CP2K`` offers additional functionality.

The following example can be used to generate a pro-atom database with the
elements, O, Na, Al and Si, the GTH pseudopotential and the MolOpt basis
set.
...
to compute charges charges, and write them into a simple text file.
